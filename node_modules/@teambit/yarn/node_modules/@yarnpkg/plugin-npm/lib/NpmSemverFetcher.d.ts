...
export declare class NpmSemverFetcher implements Fetcher {
    ...
    static isConventionalTarballUrl(locator: Locator, url: string, { configuration }: {
        configuration: Configuration;
    }): boolean;
    static getLocatorUrl(locator: Locator): string;
}
