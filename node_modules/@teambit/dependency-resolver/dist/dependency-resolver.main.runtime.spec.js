...
describe('DepenendencyResolverMain.getNetworkConfig()', () => {
  ...
  it('should return settings from global config', async () => {
    ...
    // @ts-ignore
    _http().Http.getNetworkConfig.mockReturnValue(Promise.resolve(globalConfig));
  ...
  it('should return settings from package manager config', async () => {
    ...
    // @ts-ignore
    _http().Http.getNetworkConfig.mockReturnValue(Promise.resolve({}));
...
//# sourceMappingURL=dependency-resolver.main.runtime.spec.js.map