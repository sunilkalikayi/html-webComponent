...
class NewerVersionFound extends _abstractError().default {
  constructor(newerVersions) {
    super();
    (0, _defineProperty2().default)(this, "newerVersions", void 0);
    this.name = 'NewerVersionFound';
    this.newerVersions = newerVersions;
  }
}
exports.default = NewerVersionFound;