...
class PackageJsonVinyl extends _abstractVinyl().default {
  ...
  async write() {
    ...
    if (stat) {
      if (stat.isSymbolicLink()) {
        ...
        throw new (_validationError().default)(`fatal: trying to write a package.json file into a symlink file at "${this.path}"`);
      }
      if (!this.override) {
        // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
        _logger().default.debug(`package-json-vinyl.write, ignore existing file ${this.path}`);
        // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
        return this.path;
      }
    }
    // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
    _logger().default.debug(`package-json-vinyl.write, path ${this.path}`);
    // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
  ...
  static load({
    ...
    const jsonStr = (0, _stringifyPackage().default)(content, indent, newline);
    // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
