...
describe('Dependencies', () => {
  describe('validate()', () => {
    ...
    let validateFunc;
    beforeEach(() => {
      const dependenciesFixtureCloned = (0, _clone2().default)(_dependenciesFixture().default);
    ...
    it('should throw when a dependency has the same id as the component', () => {
      const id = _bitId().BitId.parse(_dependenciesFixture().default[0].id);
      validateFunc = () => dependencies.validate(id);
      (0, _chai().expect)(validateFunc).to.throw('one of the dependencies has the same id as the component');
    });
  });
});