  ...
  walker.walk(src, function (node) {
    switch (node.type) {
      ...
      case 'ImportExpression':
        {
          var _node$source, _node$source2;
          // node represents Dynamic Imports such as import(source)
          if ((_node$source = node.source) !== null && _node$source !== void 0 && _node$source.value) addDependency((_node$source2 = node.source) === null || _node$source2 === void 0 ? void 0 : _node$source2.value);
          break;
        }
      case 'Decorator':
