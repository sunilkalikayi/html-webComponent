...
function extractDependencies(importStatementNode) {
  var _importStatementNode$, _importStatementNode$2;
  ...
  if ((importStatementNode.name === 'use' || importStatementNode.name === 'forward') && importStatementNode.prelude.type === 'AtrulePrelude' && (_importStatementNode$ = importStatementNode.prelude.children) !== null && _importStatementNode$ !== void 0 && (_importStatementNode$2 = _importStatementNode$.head) !== null && _importStatementNode$2 !== void 0 && _importStatementNode$2.data) {
    const getDepName = () => {
      var _importStatementNode$3, _importStatementNode$4;
      const headData = (_importStatementNode$3 = importStatementNode.prelude.children) === null || _importStatementNode$3 === void 0 ? void 0 : (_importStatementNode$4 = _importStatementNode$3.head) === null || _importStatementNode$4 === void 0 ? void 0 : _importStatementNode$4.data;
