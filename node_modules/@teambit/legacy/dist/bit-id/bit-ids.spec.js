...
describe('bitIds', () => {
  ...
  describe('difference', () => {
    it('should remove entries from the provided array', () => {
      ...
      const bitIds = _().BitIds.fromArray([a, b]);
      const bitIds2 = _().BitIds.fromArray([b, c]);
      const res = bitIds.difference(bitIds2);
      (0, _chai().expect)(res).to.have.lengthOf(1);
      (0, _chai().expect)(res.serialize()[0].toString()).to.equal('a');
    });
  });
});