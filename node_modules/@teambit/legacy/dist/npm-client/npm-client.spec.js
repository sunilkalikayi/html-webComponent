...
function _mockery() {
  const data = _interopRequireDefault(require("mockery"));
  _mockery = function () {
    return data;
  };
  return data;
...
describe.skip('npmClient.install()', () => {
  const execSpy = _sinon().default.spy();
  ...
  before(() => {
    ...
    _mockery().default.registerMock('child_process', childProcessMock);
    _mockery().default.registerMock('fs-extra', fsMock);
  });
  after(() => {
