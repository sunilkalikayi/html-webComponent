...
exports.LEVEL = exports.Analytics = void 0;
function _isEmpty2() {
...
class Analytics {
  ...
  static promptAnalyticsIfNeeded() {
    ...
    if (shouldPromptForAnalytics()) {
      ...
      if (!(0, _globalConfig().getSync)(_constants().CFG_ANALYTICS_USERID_KEY)) (0, _globalConfig().setSync)(_constants().CFG_ANALYTICS_USERID_KEY, uniqId);
      // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
      // @ts-ignore AUTO-ADDED-AFTER-MIGRATION-PLEASE-FIX!
