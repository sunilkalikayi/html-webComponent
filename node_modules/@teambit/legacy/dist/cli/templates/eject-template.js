...
use the '--force' flag to discard local modifications and proceed with the eject process.\n` : '';
    ...
    const selfHosted = failures.selfHostedExportedComponents.length ? `components that were exported to a self hosted scope (not ${_constants().BASE_CLOUD_DOMAIN}): ${failures.selfHostedExportedComponents.toString()}\n` : '';
