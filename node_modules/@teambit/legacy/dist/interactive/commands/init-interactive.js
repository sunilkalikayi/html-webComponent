...
exports.default = exports.TOP_MESSAGE = exports.PACKAGE_MANAGER_MSG_Q = exports.DEFAULT_DIR_MSG_Q = exports.CHOOSE_ENV_MSG_TEMPLATE_Q = exports.CHOOSE_CUSTOM_ENV_MSG_TEMPLATE_Q = exports.CHOOSE_CUSTOM_COMPILER_MSG_Q = exports.CHOOSE_COMPILER_MSG_Q = void 0;
function _chalk() {
...
var initInteractive = async function initInteractive() {
  ...
  return (0, _consumer().init)(undefined, false, false, false, false, false, false, answers).then(({
    created,
    addedGitHooks,
    existingGitHooks
  }) => {
