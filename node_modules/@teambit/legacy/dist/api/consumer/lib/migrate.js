 ...
 */
async function migrate(scopePath, verbose) {
  _logger().default.trace('migrate.migrate, starting migration process');
  ...
  if (scopePath) {
    _logger().default.trace(`migrate.migrate, running migration process for scope in path ${scopePath}`);
  ...
  _logger().default.trace('migrate.migrate, running migration process for scope in consumer');
