...
class GitNotFound extends _abstractError().default {
  constructor(gitExecutablePath, err) {
    super();
    (0, _defineProperty2().default)(this, "gitExecutablePath", void 0);
