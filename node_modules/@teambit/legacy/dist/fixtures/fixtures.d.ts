...
export declare const comp3V2 = "module.exports = () => 'comp3 v2';";
...
export declare const isStringHarmony = "const isType = require('../is-type/is-type.js'); module.exports = function isString() { return isType() +  ' and got is-string'; };";
...
export declare const appPrintBarFooModulePath: (remoteScope: any) => string;
export declare const appPrintComp1: (remoteScope: any) => string;
...
export declare const fooFixtureV3 = "module.exports = function foo() { return 'got foo v3'; }";
